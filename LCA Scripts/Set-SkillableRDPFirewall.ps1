...
$nfwAddressFilter = (Get-NetFirewallRule -DisplayName "Remote Desktop - Shadow (TCP-In)" | Get-NetFirewallAddressFilter )
Set-NetFirewallAddressFilter -InputObject $nfwAddressFilter -RemoteAddress 104.214.106.0/25, 185.254.59.0/24, 103.18.85.0/24, 163.47.101.0/25, 54.0.0.0/8, 168.245.203.241-168.245.203.254, 206.196.30.1-206.196.30.56
